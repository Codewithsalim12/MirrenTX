      ...
      <head>
        ...
        <style>
          ...
          @media only screen and (max-width: 600px) {
            ...
            .footer-signoff { margin-bottom: 24px !important; }
          }
        </style>
      </head>
      <body>
            ...
            <div class="footer">
              ...
              ` : `
                <div style="text-align: center; margin-bottom: 40px;">
                  <a href="${baseUrl}/rentals" style="display: inline-block; padding: 16px 32px; background-color: #1a1a1a; color: #ffffff; text-decoration: none; border-radius: 12px; font-weight: 700; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; width: 80%;">View All Rentals</a>
                </div>
