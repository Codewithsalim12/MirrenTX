          ...
          <div className="hidden md:flex lg:hidden items-center gap-1">
            {session ? (
              <div className="relative">
                ...
                {profileDropdownOpen && (
                  <div className="absolute right-0 mt-1 w-36 bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg shadow-2xl py-1 z-[9999] animate-in slide-in-from-top-2 duration-200">
