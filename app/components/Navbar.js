        ...
        <div className="flex justify-between items-center h-16 lg:h-20 w-full overflow-hidden">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <div className="relative">
              ...
              {servicesDropdownOpen && (
                <div className="absolute left-0 mt-4 w-72 bg-white/5 backdrop-blur-2xl border border-white/30 rounded-3xl shadow-2xl py-4 z-[60] animate-in slide-in-from-top-4 duration-300">
          ...
          <div className="hidden md:flex lg:hidden items-center gap-1">
            {session ? (
              <div className="relative">
                ...
                {profileDropdownOpen && (
                  <div className="absolute right-0 mt-1 w-36 bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg shadow-2xl py-1 z-[60] animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="hidden lg:flex items-center gap-3">
            {session ? (
              <div className="relative">
                ...
                {profileDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-44 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl py-2 z-[60] animate-in slide-in-from-top-2 duration-200">
