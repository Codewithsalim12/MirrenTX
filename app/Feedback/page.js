    ...
    <div className="min-h-screen bg-[#fafcff] selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6 pt-32">
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-5 gap-12 items-start mb-32">
          ...
          >
            <div className="bg-white border border-slate-100 rounded-[2.5rem] p-10 shadow-xl shadow-slate-100/50 relative overflow-hidden">
        ...
        <section className="w-full max-w-7xl mx-auto mb-32">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl font-black text-slate-900 tracking-tight leading-[1]">
              What Our <br />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {testimonials.map((t, i) => (
                  <motion.div
                    ...
                    className="bg-white border border-slate-100 rounded-[2.5rem] p-10 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between"
                  >
                    <div>
